...
public class DDxDrive extends Command {
	...
	protected void execute() {
		...
		// moveMotor = moveMotor * Math.pow(Math.abs(moveMotor),
		// Drive.moveExponent.getValue() - 1);
		// turnMotor = turnMotor * Math.pow(Math.abs(turnMotor),
		// Drive.turnExponent.getValue() - 1);
